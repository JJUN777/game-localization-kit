...
_CODE_MESSAGES = {
    ...
    "SOURCE_REVIEW_TOKEN_INVALID": "아이콘 token 형식 또는 OCR 프롬프트의 token 정의를 확인하세요.",
    "SOURCE_REVIEW_TOKEN_CONFIRMATION_REQUIRED": "아이콘 표기가 변경되었습니다. 원본을 보고 직접 바꾼 것이 맞다면 '아이콘 표기를 직접 바꿨습니다'를 선택한 뒤 다시 검증하세요.",
