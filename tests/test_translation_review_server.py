...
class TranslationReviewServerTests(unittest.TestCase):
    ...
    def test_serves_packaged_ui_and_rejects_unauthorized_api(self) -> None:
        ...
        self.assertIn('id="issue-filter-section"', html)
        self.assertIn('data-filter="issue-number"', html)
        self.assertIn('data-filter="issue-token"', html)
        self.assertIn('data-filter="issue-term"', html)
        self.assertIn('data-filter="issue-content"', html)
        self.assertIn('data-filter="issue-untranslated"', html)
        self.assertIn("issueTypeMatch", html)
        self.assertIn('class="dot-legend"', html)
        self.assertIn("블록 상태 표시", html)
