...
> 상태: 2026-07-23 시점의 구현·검증 기록입니다. 현재 사용법은 [전체 작업 흐름](../../source/docs/WORKFLOW.md)을 기준으로 합니다.
...
- 용어 후보 TSV 생성 테스트를 포함한 전체 자동 테스트: 54개 통과
...
- warning, 미확정 아이콘과 token을 검사하는 로컬 원문 QA는 구현됐으며 사람 수정·승인 단계는 후속 작업입니다.
