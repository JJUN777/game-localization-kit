...
```text
source,count,target_candidate,target_count,status,preferred,forbidden,note,examples
```
...
1. 자동 후보 생성
2. 사용 빈도와 예문 제공
3. 사람이 preferred/forbidden/keep 결정
4. termbase에 반영
5. 전체 초벌 번역 재검사
...
- MVP 범위 밖의 기능은 `docs/IMPROVEMENTS.md`에서 관리합니다.
...
- 용어 후보 매칭을 규칙 기반으로 시작할지 LLM 보조를 함께 사용할지 여부
